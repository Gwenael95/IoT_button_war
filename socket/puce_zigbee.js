...
controller1 =  new Controller("", "", "", "", "") ; // can do that because it's auto config with AT command
...
controller3 =  new Controller("0013A20041C34AC1", "4D81", C.CHANGE_DETECTION.MASK[0][0], C.CHANGE_DETECTION.MASK[2][0], C.CHANGE_DETECTION.MASK[3][0], true) ;
